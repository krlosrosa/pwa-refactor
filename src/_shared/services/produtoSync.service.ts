import { mapProdutoDtoToCreate } from '@/infra/_services/api/mapper/produtoMapper';
import type { CreateProdutoDto } from '@/infra/_services/api/model';
import { useFindAllProdutos, findAllProdutos } from '@/infra/_services/api/service/produto/produto';
