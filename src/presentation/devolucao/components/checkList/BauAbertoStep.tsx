...
type BauAbertoStepProps = {
  setValidateStep: (validate: boolean) => void;
}

export function BauAbertoStep({ setValidateStep }: BauAbertoStepProps) {
  ...
  async function handlePhotoCaptured(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!file) return;
    updateField('fotoBauAberto', file);
    ...
    <div className="p-4 flex flex-col">
      ...
      <div className="text-center mb-3">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">
          Foto com o baú completamente aberto
        </p>
      </div>

      {/* Área principal - Foto ou botão */}
      <div className="flex-1 flex items-center justify-center">
        {checklist?.data?.fotoBauAberto ? (
          <div className="w-full space-y-3">
            ...
            <div className="relative aspect-4/3 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
              <img
                src={URL.createObjectURL(checklist.data.fotoBauAberto)}
                alt="Foto do Baú Aberto"
